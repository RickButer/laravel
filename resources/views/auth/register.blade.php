            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                                <label for="text" class="col-md-4 col-form-label text-md-right">{{ __('about me') }}</label>
    
                                <div class="col-md-6">
                                    <input id="about_me" type="text" placeholder="something about you..." class="form-control{{ $errors->has('about_me') ? ' is-invalid' : '' }}" name="about_me" value="{{ old('about_me') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" placeholder="dont worry...it's hashed" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
